...
namespace BridgeDetectSystem.service
{
    public class DataStoreManager
    {
        ...
        public void InsertFrontPivotDis()
        {
            ...
            string sql = string.Format("insert into FrontPivotDis values(newid(),get date(),'{0}',{1},{2},{3},{4})", name, frontPivotDis[0], frontPivotDis[1],frontPivotDis[2],frontPivotDis[3]);
            try
            {
                int r = dbhelper.ExecuteNonQuery(sql);
            }
